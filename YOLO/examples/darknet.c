...
extern void run_detector(int argc, char **argv,int sock);
...
//char *IP_num = "192.168.0.22";
char *IP_num = "192.168.0.34";
...
int main(int argc, char **argv)
{
    ...
    sock = socket(PF_INET, SOCK_STREAM, 0);//use IPv4 and TCP/IP protocol
    if(sock == -1){
